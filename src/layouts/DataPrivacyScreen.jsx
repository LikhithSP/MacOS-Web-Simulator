  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="w-[700px] h-[520px] bg-white rounded-3xl shadow-2xl z-10 flex flex-col px-16 py-12 relative overflow-hidden"
      >
        {/* Back Button */}
        <button 
          onClick={goBack}
        ...
        <div className="flex-1 flex flex-col items-center w-full mt-2">
          ...
          <div className="w-[440px] text-left mt-2">
            <h2 className="text-[14px] font-bold text-gray-900 mb-2">Data & Privacy</h2>
            ...
            <div className="flex items-center text-[#0066cc] cursor-pointer hover:underline text-[13px] font-medium">
