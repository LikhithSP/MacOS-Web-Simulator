...
export default function GlassClockWidget() {
  ...
  return (
    <div className={`w-40 h-40 backdrop-blur-xl rounded-3xl flex flex-col items-center justify-center text-white select-none shrink-0 pointer-events-auto relative overflow-hidden transition-all duration-300
      ${isDarkMode 
